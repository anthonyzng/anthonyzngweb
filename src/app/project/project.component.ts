...
export class ProjectComponent {
  cardData:CardData[] = [
    ...
    {title:"Comparing Computer Vision Models for Dog Breed Identification",img:"./assets/dog.png",demo_link:"https://drive.google.com/file/d/1gXKdiSSjUt9m6SMwhnqzV95KUGzHd3mp/view",code_link:"",tech:"Tech-stack : Android + TensorFlowLite + Python ,This application aims to compare RCNN & CNN model in computer vision area."}
  ]
  openUrl(url : string){
    window.open(url);
  }
